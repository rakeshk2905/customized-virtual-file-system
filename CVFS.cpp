...
void man(char *name)
{
 ...
 else if(strcmp(name,"lseek") == 0)
 {
   ...
   printf("Usage : lseek File_Name ChangelnOffset StartPoint\n");
 }
 ...
 int CreateFile(char *name, int permission)
{
 ...
 while(temp!= NULL)  //use to find empty inode
 {
    if(temp->FileType == 0)
        break;
    temp=temp->next;
 ...
 UFDTArr[i].ptrfiletable->ptrinode->Buffer,0,1024;
...
void ls_file() 
{
 ...
 printf("\nFile Name\tlnode number\tFile size\tLink count\n");
 printf("                                                        \n");
 while(temp != NULL)
 {
         if(temp->FileType != 0)
...
int main()
{
 ...
 fgets(str,80,stdin);// scanf("0/0[A'\nls",str);
